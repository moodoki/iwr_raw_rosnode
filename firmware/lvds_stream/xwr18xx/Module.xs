...
function modBuild()
{
    ...
    var srcFiles = libUtility.listAllFiles (".c", "xwr18xx", false);
    for (var k = 0 ; k < srcFiles.length; k++)
        Pkg.otherFiles[Pkg.otherFiles.length++] = srcFiles[k];

    /* Add all the .h files to the release package. */
    var incFiles = libUtility.listAllFiles (".h", "xwr18xx", false);
    ...
    var cfgFiles = libUtility.listAllFiles (".cfg", "xwr18xx", false);
    ...
    var makFiles = libUtility.listAllFiles (".mak", "xwr18xx", false);
    ...
    var cmdFiles = libUtility.listAllFiles (".cmd", "xwr18xx", false);
    ...
    var mapFiles = libUtility.listAllFiles (".map", "xwr18xx", false);
    ...
    var outFiles = libUtility.listAllFiles (".xer4f", "xwr18xx", false);
    for (var k = 0 ; k < outFiles.length; k++)
        Pkg.otherFiles[Pkg.otherFiles.length++] = outFiles[k];

    /* Add all the executables files (c674) to the release package. */
    var outFiles = libUtility.listAllFiles (".xe674", "xwr18xx", false);
    for (var k = 0 ; k < outFiles.length; k++)
        Pkg.otherFiles[Pkg.otherFiles.length++] = outFiles[k];

    /* Add all the text files to the release package: This is for the CLI scripts */
    var txtFiles = libUtility.listAllFiles (".txt", "xwr18xx", false);
    for (var k = 0 ; k < txtFiles.length; k++)
        Pkg.otherFiles[Pkg.otherFiles.length++] = txtFiles[k];

    /* Add all the test profiles to test package */
    var cfgFiles = libUtility.listAllFiles (".cfg", "xwr18xx/profiles", false);
    for (var k = 0 ; k < cfgFiles.length; k++)
        Pkg.otherFiles[Pkg.otherFiles.length++] = cfgFiles[k];
}
