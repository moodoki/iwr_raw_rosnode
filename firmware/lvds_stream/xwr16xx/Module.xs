...
function modBuild()
{
    ...
    var srcFiles = libUtility.listAllFiles (".c", "xwr16xx", false);
    for (var k = 0 ; k < srcFiles.length; k++)
        Pkg.otherFiles[Pkg.otherFiles.length++] = srcFiles[k];

    /* Add all the .h files to the release package. */
    var incFiles = libUtility.listAllFiles (".h", "xwr16xx", false);
    ...
    var cfgFiles = libUtility.listAllFiles (".cfg", "xwr16xx", false);
    ...
    var makFiles = libUtility.listAllFiles (".mak", "xwr16xx", false);
    ...
    var cmdFiles = libUtility.listAllFiles (".cmd", "xwr16xx", false);
    ...
    var mapFiles = libUtility.listAllFiles (".map", "xwr16xx", false);
    ...
    var outFiles = libUtility.listAllFiles (".xer4f", "xwr16xx", false);
