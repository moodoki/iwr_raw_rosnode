...
mssTest: buildDirectories mssTestFullRTSC $(MSS_LVDS_STREAM_UNIT_TEST_OBJECTS)
	...
	@echo '******************************************************************************'
	@echo 'Built the MSS LVDS Stream '
	@echo '******************************************************************************'
...
###################################################################################
mssTestClean:
	@echo 'Cleaning the $(MMWAVE_SDK_DEVICE_TYPE) LVDS Stream objects'
	@$(DEL) $(MSS_LVDS_STREAM_UNIT_TEST_OBJECTS) $(MSS_LVDS_STREAM_UNIT_TEST_OUT)
	@$(DEL) $(MSS_LVDS_STREAM_UNIT_TEST_MAP) $(MSS_LVDS_STREAM_UNIT_TEST_DEPENDS)
	@echo 'Cleaning the $(MMWAVE_SDK_DEVICE_TYPE) LVDS Stream RTSC package'
