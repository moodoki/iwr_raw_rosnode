...
package/cfg/mss_per4ft.oer4ft: package/cfg/mss_per4ft.c package/cfg/mss_per4ft.mak
	...
	$(RM) $@
	@$(MSG) cler4ft $< ...
	$(ti.targets.arm.elf.R4Ft.rootDir)/bin/armcl -c  -qq -pdsw225 -ms --fp_mode=strict --code_state=16 --float_support=vfpv3d16 --endian=little -mv7R4 --abi=eabi -eo.oer4ft -ea.ser4ft   -Dxdc_cfg__xheader__='"mss_configPkg_xwr14xx/package/cfg/mss_per4ft.h"'  -Dxdc_target_name__=R4Ft -Dxdc_target_types__=ti/targets/arm/elf/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_16_9_6 -O2  $(XDCINCS) -I$(ti.targets.arm.elf.R4Ft.rootDir)/include  -fs=./package/cfg -fr=./package/cfg -fc $<
	$(MKDEP) -a $@.dep -p package/cfg -s oer4ft $< -C   -qq -pdsw225 -ms --fp_mode=strict --code_state=16 --float_support=vfpv3d16 --endian=little -mv7R4 --abi=eabi -eo.oer4ft -ea.ser4ft   -Dxdc_cfg__xheader__='"mss_configPkg_xwr14xx/package/cfg/mss_per4ft.h"'  -Dxdc_target_name__=R4Ft -Dxdc_target_types__=ti/targets/arm/elf/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_16_9_6 -O2  $(XDCINCS) -I$(ti.targets.arm.elf.R4Ft.rootDir)/include  -fs=./package/cfg -fr=./package/cfg
	-@$(FIXDEP) $@.dep $@.dep
...
package/cfg/mss_per4ft.ser4ft: package/cfg/mss_per4ft.c package/cfg/mss_per4ft.mak
	...
	$(RM) $@
	@$(MSG) cler4ft -n $< ...
	$(ti.targets.arm.elf.R4Ft.rootDir)/bin/armcl -c -n -s --symdebug:none -qq -pdsw225 --code_state=16 --float_support=vfpv3d16 --endian=little -mv7R4 --abi=eabi -eo.oer4ft -ea.ser4ft   -Dxdc_cfg__xheader__='"mss_configPkg_xwr14xx/package/cfg/mss_per4ft.h"'  -Dxdc_target_name__=R4Ft -Dxdc_target_types__=ti/targets/arm/elf/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_16_9_6 -O2  $(XDCINCS) -I$(ti.targets.arm.elf.R4Ft.rootDir)/include  -fs=./package/cfg -fr=./package/cfg -fc $<
	$(MKDEP) -a $@.dep -p package/cfg -s oer4ft $< -C  -n -s --symdebug:none -qq -pdsw225 --code_state=16 --float_support=vfpv3d16 --endian=little -mv7R4 --abi=eabi -eo.oer4ft -ea.ser4ft   -Dxdc_cfg__xheader__='"mss_configPkg_xwr14xx/package/cfg/mss_per4ft.h"'  -Dxdc_target_name__=R4Ft -Dxdc_target_types__=ti/targets/arm/elf/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_16_9_6 -O2  $(XDCINCS) -I$(ti.targets.arm.elf.R4Ft.rootDir)/include  -fs=./package/cfg -fr=./package/cfg
	-@$(FIXDEP) $@.dep $@.dep
